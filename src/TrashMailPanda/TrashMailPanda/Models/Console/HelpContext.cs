        ...
        ? new HelpContext
        {
            ...
            KeyBindings =
              [
                  ...
                  new("A / 1", "Archive — move out of inbox"),
                  new("2", "Archive now, auto-delete after 30 days"),
                  new("3", "Archive now, auto-delete after 1 year"),
                  new("4", "Archive now, auto-delete after 5 years"),
        ...
        : new HelpContext
        {
            ...
            KeyBindings =
              [
                  ...
                  new("A / 1", "Archive — override with Archive"),
                  new("2", "Archive now, auto-delete after 30 days"),
                  new("3", "Archive now, auto-delete after 1 year"),
                  new("4", "Archive now, auto-delete after 5 years"),
