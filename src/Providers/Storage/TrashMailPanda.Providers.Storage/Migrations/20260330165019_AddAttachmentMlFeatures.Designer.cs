...
namespace TrashMailPanda.Providers.Storage.Migrations
{
    ...
    [Migration("20260330165019_AddAttachmentMlFeatures")]
    partial class AddAttachmentMlFeatures
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrashMailPanda.Providers.Storage.Models.EmailFeatureVector", b =>
                {
                    ...
                    b.Property<int>("HasAudioAttachments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0)
                        .HasColumnName("has_audio_attachments");

                    b.Property<int>("HasBinaryAttachments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0)
                        .HasColumnName("has_binary_attachments");

                    b.Property<int>("HasDocAttachments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0)
                        .HasColumnName("has_doc_attachments");

                    b.Property<int>("HasImageAttachments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0)
                        .HasColumnName("has_image_attachments");

                    b.Property<int>("HasListUnsubscribe")
                        .HasColumnType("INTEGER")
                        .HasColumnName("has_list_unsubscribe");

                    b.Property<int>("HasOtherAttachments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0)
                        .HasColumnName("has_other_attachments");

                    b.Property<int>("HasTrackingPixel")
                        .HasColumnType("INTEGER")
                        .HasColumnName("has_tracking_pixel");

                    b.Property<int>("HasVideoAttachments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0)
                        .HasColumnName("has_video_attachments");

                    b.Property<int>("HasXmlAttachments")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(0)
                        .HasColumnName("has_xml_attachments");
                    ...
                    b.Property<float>("TotalAttachmentSizeLog")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("REAL")
                        .HasDefaultValue(0f)
                        .HasColumnName("total_attachment_size_log");
