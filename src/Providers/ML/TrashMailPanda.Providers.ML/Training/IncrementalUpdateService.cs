...
public sealed class IncrementalUpdateService
{
    ...
    private static ActionTrainingInput MapToTrainingInput(EmailFeatureVector v) => new()
    {
        ...
        AttachmentCount = (float)v.AttachmentCount,
        TotalAttachmentSizeLog = v.TotalAttachmentSizeLog,
        HasDocAttachments = (float)v.HasDocAttachments,
        HasImageAttachments = (float)v.HasImageAttachments,
        HasAudioAttachments = (float)v.HasAudioAttachments,
        HasVideoAttachments = (float)v.HasVideoAttachments,
        HasXmlAttachments = (float)v.HasXmlAttachments,
        HasBinaryAttachments = (float)v.HasBinaryAttachments,
        HasOtherAttachments = (float)v.HasOtherAttachments,
